...
//}
//
//class CurrentGameConfigurationHelper @Inject(world: World, val renderSystem: RenderSystem, currentMasterConfiguration: CurrentMasterConfig) extends RenderEvent {
//  
